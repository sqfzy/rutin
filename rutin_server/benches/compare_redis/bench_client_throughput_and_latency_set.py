...
def run_bench():
    ...
    for clients in client_sessions:
        ...
        command_redis = (
            f"redis-benchmark -r 1000 -p 6378 -t set -c {clients} -n 10000 -q"
        )
        ...
        command_rutin = (
            f"redis-benchmark -r 1000 -p 6379 -t set -c {clients} -n 10000 -q"
        )
    ...
    fig = make_subplots(
        ...
        subplot_titles=(
            "SET Command Throughput vs. Client Sessions",
            "SET Command Latency vs. Client Sessions",
        ),
    )
    ...
    fig.write_html("result/html/bench_client_throughput&latency_set.html")
    fig.write_image("result/svg/bench_client_throughput&latency_set.svg", width=1400)
