...
#[inline]
pub unsafe fn leak_bytes(b: &[u8]) -> StaticBytes { unsafe {
...
/// 将其生命周期视为static，但实际的生命周期在执行finish_read_frames()时结束
#[inline]
pub unsafe fn leak_bytes_mut(b: &mut [u8]) -> StaticBytes { unsafe {
...
/// 将其生命周期视为static，但实际的生命周期在执行finish_read_frames()时结束
#[inline]
pub unsafe fn leak_str(s: &str) -> StaticStr { unsafe {
...
/// 将其生命周期视为static，但实际的生命周期在执行finish_read_frames()时结束
#[inline]
pub unsafe fn leak_str_mut(s: &mut str) -> StaticStr { unsafe {
