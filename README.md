...
**以下测试中，Ruin没有开启AOF，Redis没有开启多线程和AOF。在单机功能完善之后，可能会更新测试结果**

| -r代表生成随机键的范围，-P代表一个Pipline的请求数量，-n代表请求的总数 | Ruin                                                         | Redis                                                        | 结论                                                         |
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
